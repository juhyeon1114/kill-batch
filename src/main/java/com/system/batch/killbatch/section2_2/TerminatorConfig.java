...
public class TerminatorConfig {
	...
	public Step terminationStep(
		JobRepository jobRepository, PlatformTransactionManager transactionManager, Tasklet terminatorTasklet) {
	...
	public Tasklet terminatorTasklet(
		...
		return (contribution, chunkContext) -> {
			...
			for (int i = 1; i <= 3; i++) {
				...
				log.info(
					"☠️ 시스템 정리 {}시간 경과... 현재 시각:{}", i, currentTime.format(DateTimeFormatter.ofPattern("HH시 mm분")));
			}
