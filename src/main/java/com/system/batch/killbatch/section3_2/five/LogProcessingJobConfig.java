package com.system.batch.killbatch.section3_2.five;
...
public class LogProcessingJobConfig {
	...
	/**
	 * - Step1. 로그 처리에 필요한 디렉토리 생성
	 * - Step2. 서버들의 로그 파일 수집
	 * - Step3. 수집된 로그 파일 가공 및 저장
	 */
	@Bean
	...
	public SystemCommandTasklet mkdirTasklet(
		...
		tasklet.setWorkingDirectory("~/apps-private/kill-batch");
	...
	public SystemCommandTasklet scpTasklet(
		...
		for (String host : List.of("localhost")) {
			String command = String.format(
				"scp %s:~/ecommerce_logs/%s.log ./%s/%s.log",
